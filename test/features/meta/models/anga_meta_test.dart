...
''';
        ...
        expect(
          meta.tags,
          containsAll(['podcast', 'democracy', 'cooperatives']),
        );
...
''';
        ...
        expect(meta.createdAt.year, equals(2026));
        expect(meta.createdAt.month, equals(1));
        expect(meta.createdAt.day, equals(28));
        expect(meta.createdAt.hour, equals(21));
      });
    });
    ...
    group('toToml', () {
      ...
      test('uses triple quotes for multiline notes', () {
        final meta = AngaMeta(
          metaFilename: '2026-01-28T210000-meta.toml',
          path: '/kaya/meta/2026-01-28T210000-meta.toml',
          angaFilename: '2026-01-28T205208-bookmark.url',
        ...
        expect(toml, contains("note = '''Line 1\nLine 2'''"));
      });
      ...
      test('omits note when null', () {
        ...
        expect(toml, isNot(contains('note')));
      });
    });
  });
