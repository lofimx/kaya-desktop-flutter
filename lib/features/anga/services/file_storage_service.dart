...
class FileStorageService {
  ...
  /// Creates a `.nofavicon` marker file.
  ...
  Future<String?> getWordsText(String angaFilename) async {
    final files = await listWordsFiles(angaFilename);
    ...
    for (final filename in files) {
      final content =
          await readFileContent('$wordsPath/$angaFilename/$filename');
...
Future<String> kayaRootPath(Ref ref) async {
  // On all platforms, use ~/.kaya/ (home directory)
